namespace PolymorphicPseudonymisation
{
    ...
    {
        public const string ECSignature = "0.4.0.127.0.7.1.1.4.3.3";
        ...
        public const string SignedEncryptedIdentityNameV2 = "2.16.528.1.1003.10.1.2.7.2";
        public const string SignedEncryptedPseudonymName = "2.16.528.1.1003.10.1.2.4";
        public const string SignedEncryptedPseudonymNameV2 = " 2.16.528.1.1003.10.1.2.8.2";
    }
}